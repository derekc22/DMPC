...
def plot_xyz(M, x_cl, x0_val, xf_val, J_cl_avg, obs, dyn, fname, wall_clk, qualifier=""):
    ...
    plt.title(f'{fname} mpc\n Jbar = {J_cl_avg :.3f}, clk: {wall_clk :.3f}s')
    plt.tight_layout()
...
# def animate_xyz_gif(M, x_cl, x0_val, xf_val, J_cl_avg, obs, dyn, fname, wall_clk, qualifier="", fps=10):
...
#         frame_path = f"figures_frame_{t:05d}.png"
